...
const generateCompactDescription = (
  step: Step & { time?: number; pourTime?: number; endTime?: number },
  showFlowRate: boolean,
  allSteps: Step[]
) => {
              ...
              (() => {
                ...
                return (
                  <div className="space-y-3 py-3">
                    {/* 主要描述 - 自然语言 */}
                    <div className="text-xl leading-relaxed font-medium text-neutral-600 dark:text-neutral-400">
