...
const handleChange = async <K extends keyof SettingsOptions>(
    ...
    return (
        <div className="fixed inset-0 z-50 pt-safe-top  max-w-[640px] sm:max-w-full mx-auto bg-neutral-50 dark:bg-neutral-900 transition-opacity duration-200 opacity-100 pointer-events-auto flex flex-col">
            {/* 头部导航栏 */}
            <div
                className="relative flex items-center justify-center pb-4 sm:max-w-sm w-full mx-auto"
            >
                <button
                    onClick={onClose}
