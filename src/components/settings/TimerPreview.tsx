...
const createSampleTimerData = (currentTime: number) => {
    ...
    const stageLabels = ['焖蒸(绕圈注水)', '等待', '绕圈注水', '等待', '中心注水']
    ...
    return {
        ...
        currentStage: {
            ...
            label: stageLabels[currentStageIndex] || currentStage.type === 'pour' ? '绕圈注水' : '等待',
            endTime: currentStage.endTime,
            water: currentStage.water,
        },
        nextStage: {
            type: nextStage.type as 'pour' | 'wait',
            label: stageLabels[currentStageIndex + 1] || (nextStage.type === 'pour' ? '绕圈注水' : '等待'),
...
const TimerPreview: React.FC<TimerPreviewProps> = ({ settings }) => {
    ...
    return (
        <div className="relative min-h-12 mb-8 overflow-hidden bg-neutral-50 dark:bg-neutral-900">
            {/* 预览标识 */}
                ...
                <div className="flex flex-col justify-end px-6 py-3">
                    ...
                    {alwaysShowTimerInfo && (
                        <div className="space-y-3">
                            {/* 当前阶段信息 */}
                            <div className={`flex items-baseline border-l-2 border-neutral-800 pl-3 dark:border-neutral-100 ${
                                ...
                                <div className={`flex items-baseline flex-row ${
                                    ...
                                    <div className={`${showFlowRate ? 'min-w-20' : 'min-w-24'}`}>
                                        ...
                                        <div className={`mt-1 flex flex-col text-sm font-medium tracking-wide`}>
                            ...
                            {/* 下一阶段信息 */}
                            <div className={`flex items-baseline border-l border-neutral-300 pl-3 dark:border-neutral-700 ${
                                stageInfoReversed ? "flex-row-reverse" : "flex-row"
                            } justify-between`}>
                                <div className={stageInfoReversed ? "text-right" : "text-left"}>
                            ...
                            <div className="relative mb-3">
                                ...
                                <div className="relative mt-1 h-3 w-full">
                                    ...
                                    <div className="absolute top-0 right-0 font-medium text-[9px] text-neutral-600 dark:text-neutral-300">
            ...
            {/* 上边缘渐变阴影 */}
            <div className="absolute top-0 left-0 right-0 h-6 bg-gradient-to-b from-neutral-50 via-neutral-50/80 to-transparent dark:from-neutral-900 dark:via-neutral-900/80 pointer-events-none z-20" />
            
            {/* 下边缘渐变阴影 */}
            <div className="absolute bottom-0 left-0 right-0 h-6 bg-gradient-to-t from-neutral-50 via-neutral-50/80 to-transparent dark:from-neutral-900 dark:via-neutral-900/80 pointer-events-none z-20" />
        </div>
    )
}
