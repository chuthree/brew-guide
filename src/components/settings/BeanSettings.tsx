...
const BeanSettings: React.FC<BeanSettingsProps> = ({
    ...
    return (
        ...
        >
            {/* 头部导航栏 */}
            <div className="relative flex items-center justify-center py-4 pt-safe-top sm:max-w-sm w-full mx-auto sm:max-w-sm w-full mx-auto">
                <button
                    onClick={onClose}
            ...
            {/* 滚动内容区域 */}
            <div className="relative flex-1 overflow-y-auto pb-safe-bottom sm:max-w-sm w-full mx-auto sm:max-w-sm w-full mx-auto sm:max-w-sm w-full mx-auto">
                {/* 预览区域 */}
