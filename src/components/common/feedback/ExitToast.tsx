...
export function ExitToast() {
    ...
    return (
        ...
        >
            <div className="bg-neutral-800/95 dark:bg-neutral-200/95 backdrop-blur-sm text-white dark:text-neutral-900 px-5 py-3 rounded-full text-sm font-medium shadow-lg whitespace-nowrap">
                {EXIT_TOAST_TEXT}
            </div>
        </div>
    )
