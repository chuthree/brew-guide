...
interface UseEnhancedNotesFilteringReturn {
  ...
  debouncedUpdateFilters: (
    filters: Partial<UseEnhancedNotesFilteringProps>
  ) => void;
}
...
export const useEnhancedNotesFiltering = ({
  ...
  const debouncedUpdateFilters = useCallback(
    (_filters: Partial<UseEnhancedNotesFilteringProps>) => {
...
export const useAsyncBeanFiltering = () => {
  const filterNotesByBeanAsync = useCallback(
    async (notes: BrewingNote[], selectedBean: string) => {
