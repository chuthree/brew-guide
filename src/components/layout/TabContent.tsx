...
const TabContent: React.FC<TabContentProps> = ({
  ...
  const buttonBaseClass =
    'rounded-full border border-neutral-200/50 dark:border-neutral-800/50 bg-neutral-100 dark:bg-neutral-800/20 text-neutral-800 dark:text-neutral-100';
              ...
              {isSearching && (
                ...
                >
                  <input
                    ...
                    placeholder="搜索咖啡豆名称..."
                    className="w-48 rounded-full border border-neutral-200/50 bg-neutral-100 px-5 py-[14px] text-sm font-medium text-neutral-800 placeholder-neutral-400 outline-hidden dark:border-neutral-800/50 dark:bg-neutral-800/20 dark:text-neutral-100 dark:placeholder-neutral-500"
                    autoComplete="off"
