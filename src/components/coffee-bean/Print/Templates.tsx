...
export const DetailedTemplate: React.FC<TemplateProps> = ({
  ...
  const rows = [
    ...
    { field: 'region', value: content.region },
    { field: 'estate', value: content.estate },
    { field: 'lot', value: content.lot },
    { field: 'batch', value: content.batch },
    { field: 'station', value: content.station },
    { field: 'altitude', value: content.altitude },
    { field: 'season', value: content.season },
    { field: 'process', value: content.process },
    { field: 'variety', value: content.variety },
    { field: 'agtron', value: content.agtron },
