                ...
                <>
                    ...
                    >
                        ...
                        <div className="px-6 pb-safe-bottom overflow-auto max-h-[calc(85vh-40px)]">
                            ...
                            {/* 咖啡豆信息 */}
                            <div className="mb-6">
                                <h3 className="text-base font-medium text-neutral-800 dark:text-neutral-100 mb-2">
                                    {bean.name}
                                </h3>
                                {bean.roastLevel && (
                            ...
                            {shareMode === 'qrcode' && (
                                <>
                                    {/* 显示咖啡豆名称开关 */}
                                    <div className="mb-4 flex items-center justify-between p-3 bg-neutral-100 dark:bg-neutral-800 rounded-lg">
                                    ...
                                    <div className="mb-6 flex justify-center">
                                        <div 
                                            ref={qrContainerRef}
                                            className="bg-white p-6 rounded-lg w-full max-w-[400px]"
                                        >
                                            {/* 咖啡豆名称 - 可选显示 */}
                                    ...
                                    <div className="flex gap-3 mb-4">
                                        <button
                                            ...
                                            disabled={isSharing}
                                            className="flex-1 flex items-center justify-center gap-2 py-3 bg-neutral-900 dark:bg-neutral-100 text-neutral-100 dark:text-neutral-900 rounded-lg hover:opacity-90 transition-opacity disabled:opacity-50"
                                        >
                                        ...
                                        {!Capacitor.isNativePlatform() && typeof navigator !== 'undefined' && 'share' in navigator && (
                                            <button
                                                onClick={handleShareQRCode}
                                                disabled={isSharing}
                                                className="flex-1 flex items-center justify-center gap-2 py-3 bg-neutral-200 dark:bg-neutral-800 text-neutral-800 dark:text-neutral-100 rounded-lg hover:opacity-90 transition-opacity disabled:opacity-50"
                                            >
                                                <Share2 className="w-4 h-4" />
                                ...
                                <>
                                    ...
                                    <div className="mb-4">
                                        <button
                                            ...
                                            className="w-full flex items-center justify-center gap-2 py-3 bg-neutral-900 dark:bg-neutral-100 text-neutral-100 dark:text-neutral-900 rounded-lg hover:opacity-90 transition-opacity"
                                        >
                                            <FileText className="w-4 h-4" />
