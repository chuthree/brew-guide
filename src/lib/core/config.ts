...
export const availableGrinders: Grinder[] = [
	...
	{ id: "1z_zp6", name: "1Z ZP6", grindSizes: {
		...
		细: "3.5-4格",     // 摩卡壶
		中细: "4-5格",     // 官方推荐手冲
		中细偏粗: "4.5-5.5格", // 手冲偏厚、V60 或 Kalita
		中粗: "5-5.5格",   // 爱乐压、聪明杯
		粗: "5.5-6格",     // 法压壶（官方推荐）
		特粗: "6-6.5格",   // 冷萃（跨度有限，只能靠近法压档位）
		土耳其: "2-2.5格",
		意式: "2.5-3.5格",
		摩卡壶: "3.5-4格",
		手冲: "4-5格",     // 官方推荐
	...
	{ id: "c5", name: "栗子 C5", grindSizes: {
        极细: "5-6格",     // 意式浓缩（官方 5 起）
        特细: "6-7格",     // 意式顺滑流速
        细: "7-9格",       // 摩卡壶
        中细: "10-12格",   // 手冲（官方 10–14）
        中细偏粗: "12-14格", // 手冲偏厚
        中粗: "14-15格",   // 法压壶（官方 14–17）
        粗: "15-16格",     // 法压壶偏粗
        特粗: "16-17格",   // 冷萃（跨度不大）
        意式: "5-8格",     // 官方推荐
        摩卡壶: "5-8格",   // 官方推荐（与意式相同）
    ...
    { id: "c5_esp", name: "栗子 C5 ESP", grindSizes: {
        极细: "1.5.0-1.0.0",     // 意式浓缩（超细研磨）
        特细: "1.2.0-1.3.0",     // 意式顺滑流速
        细: "1.3.0-1.4.0",       // 摩卡壶
        中细: "1.5.0-1.8.0",     // 手冲前段
        中细偏粗: "1.8.0-2.0.0", // 手冲后段
        中粗: "2.0.0-2.2.0",     // 法压壶前段
        粗: "2.2.0-2.4.0",       // 法压壶后段
        特粗: "2.4.0-2.6.0",     // 冷萃
        意式: "1.5.0-1.2.0",     // 官方推荐（浓缩/摩卡）
        摩卡壶: "1.5.0-1.2.0",   // 官方推荐（与意式相同）
        手冲: "1.5.0-2.0.0",     // 官方推荐
        法压壶: "2.0.0-2.4.0",   // 官方推荐
        冷萃: "2.4.0-2.6.0",
    }},
	...
	{ id: "wizard_2_all", name: "巫师 2 全能版", grindSizes: {
		极细: "7-10格",    // 意式浓缩（偏快速出液）
		特细: "10-13格",   // 意式（更顺滑）
		细: "13-16格",     // 摩卡壶
		中细: "16-21格",   // 手冲
		中细偏粗: "21-25格", // V60/锥滤 手冲偏厚
		中粗: "25-32格",   // 法压壶/聪明杯
		粗: "32-40格",     // 法压壶偏粗
		特粗: "40-48格",   // 冷萃
		意式: "9-13格",    // 意式浓缩（参考全能款）
				...
				stages: [
					{
						...
						label: "绕圈注水",
						water: "36g",
						detail: "平铺表面，相当于闷蒸 - 快速湿润与尽量不搅动粉层的方式来进行类闷蒸处理",
						pourType: "circle",
					},
					{
						time: 240,
					...
					},
					{
						...
						label: "绕圈注水",
						water: "200g",
						detail: "第二段注水后等液面降至粉下后，再进行第三段注水。注水完成后等待滴落状态至滴水时，即完成，之后可依据习惯添加水至喜欢的浓淡即可",
						pourType: "circle",
					},
				],
			},
